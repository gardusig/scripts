...
from prompt_craft.cli.process_app import process_app
...
def mock_file_operations():
    with (
        patch("prompt_craft.cli.process_app.get_all_files") as mock_get_all_files,
        patch("prompt_craft.cli.process_app.append_processing_file") as mock_append,
        patch("prompt_craft.cli.process_app.remove_processing_file") as mock_remove,
        patch("prompt_craft.cli.process_app.clear_processing_files") as mock_clear,
        patch("prompt_craft.cli.process_app.summary_processing_files") as mock_summary,
        patch("prompt_craft.cli.process_app.undo_processing_files") as mock_undo,
    ):
